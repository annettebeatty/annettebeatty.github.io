...
(function($){
    ...
    $(".modal-box").on('click', function(e) {
        ...
        console.log("Clicked box = ", clicked);

        switch (clicked)
        {
            case "rps":
            {
                window.location.href = "https://annettebeatty.github.io/RPS/";
                break;
            }

            case "trivia":
            {
                window.location.href = "https://annettebeatty.github.io/Word-Guess-Game/";
                break;
            }

            case "saveats":
            {
                window.location.href = "https://johndavidbeatty.github.io/GroupProject/design_fast.html";
                break;
            }

            case "starwars":
            {
                window.location.href = "https://annettebeatty.github.io/unit-4-game/";
                break;
            }
        }
